...
var AssetWhere = struct {
	...
	ProjectID:       whereHelperstring{field: "\"open_bos\".\"asset\".\"project_id\""},
...
var (
	assetAllColumns            = []string{"id", "configuration_id", "project_id", "global_asset_id", "provider_id", "asset_id", "is_root_space"}
