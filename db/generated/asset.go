...
type Asset struct {
	...
	IsRootSpace     bool       `boil:"is_root_space" json:"is_root_space" toml:"is_root_space" yaml:"is_root_space"`
...
var AssetTableColumns = struct {
	...
	IsRootSpace:     "asset.is_root_space",
}
...
var AssetWhere = struct {
	...
	IsRootSpace     whereHelperbool
}{
	ID:              whereHelperint64{field: "\"open_bos\".\"asset\".\"id\""},
	ConfigurationID: whereHelperint64{field: "\"open_bos\".\"asset\".\"configuration_id\""},
	GlobalAssetID:   whereHelperstring{field: "\"open_bos\".\"asset\".\"global_asset_id\""},
	ProviderID:      whereHelperstring{field: "\"open_bos\".\"asset\".\"provider_id\""},
	AssetID:         whereHelpernull_Int32{field: "\"open_bos\".\"asset\".\"asset_id\""},
	IsRootSpace:     whereHelperbool{field: "\"open_bos\".\"asset\".\"is_root_space\""},
}
...
func (o *Asset) GetOpenbosDatapoints() OpenbosDatapointSlice {
	if o == nil {
		return nil
	}

	return o.R.GetOpenbosDatapoints()
}
...
var (
	assetAllColumns            = []string{"id", "configuration_id", "global_asset_id", "provider_id", "asset_id", "is_root_space"}
	assetColumnsWithoutDefault = []string{"global_asset_id", "provider_id"}
	assetColumnsWithDefault    = []string{"id", "configuration_id", "asset_id", "is_root_space"}
...
func (assetL) LoadConfiguration(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`open_bos.configuration`),
		qm.WhereIn(`open_bos.configuration.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Assets(mods ...qm.QueryMod) assetQuery {
	mods = append(mods, qm.From("\"open_bos\".\"asset\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"open_bos\".\"asset\".*"})
	}
...
func FindAsset(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Asset, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"open_bos\".\"asset\" where \"id\"=$1", sel,
	)
...
func (o *Asset) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"open_bos\".\"asset\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"open_bos\".\"asset\" %sDEFAULT VALUES%s"
		}
...
func (o *Asset) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"open_bos\".\"asset\" SET %s WHERE %s",
...
func (o AssetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"open_bos\".\"asset\" SET %s WHERE %s",
...
func (o *Asset) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"open_bos\".\"asset\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Asset) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"open_bos\".\"asset\" WHERE \"id\"=$1"
...
func (o *AssetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"open_bos\".\"asset\".* FROM \"open_bos\".\"asset\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, assetPrimaryKeyColumns, len(*o))
...
func AssetExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"open_bos\".\"asset\" where \"id\"=$1 limit 1)"
